...
export function emailChangeCodeEmail(code: string) {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Confirma tu nuevo correo - Mercamesa</title>
      <style>
        body { font-family: Arial, sans-serif; background-color: #FAFAF5; color: #1A2610; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 20px rgba(26, 51, 8, 0.08); border: 1px solid #E2E2D0; }
        .header { background-color: #1A3308; padding: 40px 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2 class="title">Confirma tu nuevo correo</h2>
...
export function emailChangeNotificationEmail(newEmail: string) {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Solicitud de cambio de correo - Mercamesa</title>
      <style>
        body { font-family: Arial, sans-serif; background-color: #FAFAF5; color: #1A2610; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 20px rgba(26, 51, 8, 0.08); border: 1px solid #E2E2D0; }
        .header { background-color: #1A3308; padding: 40px 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2 class="title">Se solicitó cambiar tu correo</h2>
          <p class="text">Alguien solicitó cambiar el correo de tu cuenta MercaMesa a <span class="highlight">${newEmail}</span>.</p>
          <p class="text">Si fuiste tú, no necesitas hacer nada más. Si <strong>no</strong> reconoces esta solicitud, cambia tu contraseña de inmediato o contáctanos.</p>
        </div>
        <div class="footer">
          <p>&copy; 2026 Mercamesa. Todos los derechos reservados.<br>Conectando el campo y la ciudad.</p>
        </div>
...
export function passwordChangedEmail() {
  return `
    ...
    <head>
      <meta charset="utf-8">
      <title>Contraseña actualizada - Mercamesa</title>
      <style>
        body { font-family: Arial, sans-serif; background-color: #FAFAF5; color: #1A2610; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 20px rgba(26, 51, 8, 0.08); border: 1px solid #E2E2D0; }
        .header { background-color: #1A3308; padding: 40px 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2 class="title">Tu contraseña fue actualizada</h2>
          <p class="text">Acabas de cambiar la contraseña de tu cuenta MercaMesa.</p>
          <p class="text">Si <strong>no</strong> reconoces este cambio, contáctanos de inmediato: alguien más podría tener acceso a tu cuenta.</p>
        </div>
        <div class="footer">
          <p>&copy; 2026 Mercamesa. Todos los derechos reservados.<br>Conectando el campo y la ciudad.</p>
        </div>
...
export function emailChangeConfirmedEmail(newEmail: string) {
  return `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
      <title>Correo actualizado - Mercamesa</title>
      <style>
        body { font-family: Arial, sans-serif; background-color: #FAFAF5; color: #1A2610; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 20px rgba(26, 51, 8, 0.08); border: 1px solid #E2E2D0; }
        .header { background-color: #1A3308; padding: 40px 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2 class="title">Tu correo fue actualizado</h2>
          <p class="text">El correo de tu cuenta MercaMesa ahora es <span class="highlight">${newEmail}</span>.</p>
          <p class="text">Si <strong>no</strong> reconoces este cambio, contáctanos de inmediato.</p>
        </div>
        <div class="footer">
          <p>&copy; 2026 Mercamesa. Todos los derechos reservados.<br>Conectando el campo y la ciudad.</p>
        </div>
