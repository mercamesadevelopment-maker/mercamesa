...
export function StoreCategoriesTab() {
  ...
  const handleOpenEdit = (item: StoreCategoryRow) => {
      ...
      render: (item: StoreCategoryRow) => (
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-mm-gbg rounded-lg flex items-center justify-center text-mm-g font-bold shrink-0">
            <Store className="w-5 h-5 text-mm-g" />
          </div>
          <div>
  ...
  if (loading) return <div className="p-8 text-center text-mm-txs">Cargando categorías de tienda...</div>;
          ...
          <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-fraunces text-mm-g mb-6">
                {editingCategory ? 'Editar Categoría de Tienda' : 'Nueva Categoría de Tienda'}
              </h3>
